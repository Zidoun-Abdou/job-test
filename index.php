...
<body>
<header class="container" style="background-color: #f9f9f9;">
    <div class="container py-4 text-black pb-5">
        <div class="float-right mr-4 mt-0 pt-0">
            <img src="img/logo.jpg" class="img-rounded" alt="Error image" style="height: 180px ; width: 180px">
        </div>
        <br><br>
...
<footer class="container" style="background-color: #f9f9f9;">
    <div class="container py-4 text-black pb-5">
        <div class="float-left mr-4 mt-0 pt-0">
            <img src="img/logo.jpg" class="img-rounded" alt="Error image" style="height: 180px ; width: 180px">
        </div>
        <br><br>
        <div class="float-left">
